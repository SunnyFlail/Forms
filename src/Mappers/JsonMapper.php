...
class ValueMapper implements IValueMapper
{
    ...
    {
        if ($field instanceof ISerializedEntityField) {
            ...
            return $this->scrapeSerializingField($field);
        }
    ...
    protected function scrapeSerializingField(ISerializedEntityField $field): mixed
    {
        if (null === ($classFQCN = $field->getClassName())) {
            return $field->getValue();
        }
